...
public class StepFunctionEmailSenderFactory implements EmailSenderFactory {

    @Override
    public EmailSender getSender(String env, RecipientsCluster cluster, EmailType type) {
        throw new UnsupportedOperationException("Step Functions email sender is not implemented yet!");
    }
