...
public class StepFunctionJobExecutor implements SingleJobExecutor {
    private static final Logger LOGGER = LoggerFactory.getLogger(StepFunctionJobExecutor.class);
    ...
    public StepFunctionJobExecutor(
    ...
    public ExecutorResult<ExecutorExitCode> execute(DataIdentifier dataId) {
        ...
        try (SfnClient sfnClient = getSfnClient()) {
            ...
            LOGGER.error("StepFunctionJobExecutor failed for state machine {}!", job.getStateMachineArn(), ex);
