...
public class UnregisteredDataIdentifierException extends PlatformException {
    private static final long serialVersionUID = -6968417410384788594L;

    private final DataIdentifier dataIdentifier;

    public UnregisteredDataIdentifierException(DataIdentifier dataIdentifier) {
        super("dataIdentifier " + dataIdentifier + " has not been registered as input!");
