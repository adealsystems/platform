...
public final class DataInstance implements Comparable<DataInstance> {
    ...
    /**
     * Resolves the path of this DataInstance or throws an exception if that isn't possible.
     *
     * @return the resolved path
     * @throws IllegalStateException if this DataInstance does not have a path.
     */
    public String resolvePath() {
        String path = getPath().orElse(null);
        if (path == null) {
            throw new IllegalStateException("dataInstance " + this + " does not provide a path!");
        }
    ...
    public String toString() {
        ...
        builder.append(dataIdentifier.toString()).append('#');
        if (date == null) {
