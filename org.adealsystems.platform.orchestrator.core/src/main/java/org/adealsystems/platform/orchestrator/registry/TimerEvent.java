...
public final class TimerEvent implements EventDescriptor {
    ...
    public static TimerEvent forId(String id){
        return new TimerEvent(id);
    }

    private TimerEvent(String id) {
        this.id = Objects.requireNonNull(id, "id must not be null!");
    }

    public TimerEvent asStartEvent() {
        this.startEvent = true;
        return this;
    }

    public TimerEvent asStopEvent() {
        this.stopEvent = true;
        return this;
    }
    ...
    public TimerEvent withPattern(String pattern) {
        this.pattern = Pattern.compile(Objects.requireNonNull(pattern, "pattern must not be null!"));
        return this;
    }

    public TimerEvent withPattern(Pattern pattern) {
