...
public class EventProcessingStepDeserializer extends StdDeserializer<EventProcessingStep> {
    protected EventProcessingStepDeserializer() {
        super(EventProcessingStep.class);
    }

    @Override
    public EventProcessingStep deserialize(JsonParser parser, DeserializationContext ctx) {
        RootNode rootNode = parser.readValueAs(RootNode.class);
        return new EventProcessingStep(rootNode.success, rootNode.event, rootNode.message);
    }
